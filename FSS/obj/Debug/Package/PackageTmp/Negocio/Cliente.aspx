...
<article>
    ...
    <div style="text-align:center" >
        <br /><br />
        <asp:GridView ID="grdCliente" runat="server" CssClass="table table-responsive table-bordered" Font-Size="Medium"  SelectedRowStyle-BackColor="Violet" autogenerateselectbutton="True"
       selectedindex="0"
